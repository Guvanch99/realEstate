...
export const requiredRule:
  (message: string) => RegisterOptions['required'] = (message: string) => ({
    value: true,
...
export const maxLengthRule: (num: number) => RegisterOptions['minLength'] = (num) => ({
  value: num,
  message: `length be less than ${num}`
})
